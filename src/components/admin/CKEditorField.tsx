 ...
 *
 * Preview is intentionally NOT a split pane — it opens in a new tab (or
 * a fullscreen modal iframe) so the editor always uses the full width.
 * That flow lives in `BlogEditor.tsx`.
 */
