...
export const hero: HeroData = {
  badge: "Jasa Artikel SEO Berkualitas",
  title: "Jasa Pembuatan Artikel SEO Profesional",
  description:
  ...
  image: heroImage,
  imageAlt: "Ilustrasi workspace penulis artikel SEO dengan laptop, dokumen, dan notebook",
  imageWidth: 1024,
  imageHeight: 1024,
  isVisible: true,
};
